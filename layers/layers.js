...
var lyr__8 = new ol.layer.Vector({
    ...
    <img src="styles/legend/_8_0.png" /> Благоустройство<br />\
    <img src="styles/legend/_8_1.png" /> Борткамень<br />\
    <img src="styles/legend/_8_2.png" /> Граффити<br />\
    <img src="styles/legend/_8_3.png" /> Дефект ДИП<br />\
    <img src="styles/legend/_8_4.png" /> Иное<br />\
    <img src="styles/legend/_8_5.png" /> Освещение<br />\
    <img src="styles/legend/_8_6.png" /> Уборка<br />' });
...
cluster__9 = new ol.source.Cluster({
  distance: 30,
...
var lyr__9 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/_9.png" /> Добродел'
            });

lyr_2gisMap_0.setVisible(true);lyr__1.setVisible(true);lyr__2.setVisible(true);lyr__3.setVisible(true);lyr__4.setVisible(true);lyr__5.setVisible(true);lyr__6.setVisible(true);lyr__7.setVisible(true);lyr__8.setVisible(true);lyr__9.setVisible(true);
var layersList = [lyr_2gisMap_0,lyr__1,lyr__2,lyr__3,lyr__4,lyr__5,lyr__6,lyr__7,lyr__8,lyr__9];
...
lyr__8.set('fieldAliases', {'ID': 'ID', 'Дата': 'Дата', 'Адрес': 'Адрес', 'Характер': 'Характер', 'Вид дефекта': 'Вид дефекта', 'Фото': 'Фото', });
lyr__9.set('fieldAliases', {'Номер': 'Номер', 'Срок': 'Срок', 'Адрес': 'Адрес', 'Группа': 'Группа', 'Категория': 'Категория', 'Ссылка': 'Ссылка', });
...
lyr__8.set('fieldImages', {'ID': 'TextEdit', 'Дата': 'DateTime', 'Адрес': 'TextEdit', 'Характер': 'TextEdit', 'Вид дефекта': 'TextEdit', 'Фото': 'TextEdit', });
lyr__9.set('fieldImages', {'Номер': 'TextEdit', 'Срок': 'TextEdit', 'Адрес': 'TextEdit', 'Группа': 'TextEdit', 'Категория': 'TextEdit', 'Ссылка': 'TextEdit', });
...
lyr__8.set('fieldLabels', {'ID': 'no label', 'Дата': 'no label', 'Адрес': 'no label', 'Характер': 'no label', 'Вид дефекта': 'no label', 'Фото': 'no label', });
lyr__9.set('fieldLabels', {'Номер': 'no label', 'Срок': 'no label', 'Адрес': 'no label', 'Группа': 'no label', 'Категория': 'no label', 'Ссылка': 'no label', });
